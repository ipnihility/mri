...
control MyEgress(inout headers hdr,
    ...
    action add_swtrace(switchID_t swid) { 
		...
		hdr.swtraces[0].in_time = (ingress_timestamp_t)standard_metadata.enq_timestamp;
		hdr.swtraces[0].queue_time = (egress_timestamp_t)standard_metadata.deq_timedelta;
		hdr.mri.count = hdr.mri.count + 1;
		hdr.mri.length = hdr.mri.length + 15;
